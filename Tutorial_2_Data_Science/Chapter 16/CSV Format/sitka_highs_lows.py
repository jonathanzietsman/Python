# This program reads weather data and creates a temperature range plot
# It demonstrates data visualization with multiple datasets and shaded regions
...
path = Path(r'C:\Users\j8760\Desktop\Programming\CodeCollage\Python\Tutorial_2_Data_Science\Chapter 16\CSV Format\weather_data\sitka_weather_2021_simple.csv')
...
for row in reader:
    ...
    # Convert the temperature strings to integers
    high = int(row[4])  # High temperature from column 5
    low = int(row[5])   # Low temperature from column 6
...
# Customize the plot
ax.set_title("Daily high and low temperatures, 2021", fontsize=24)  # Add title
